...
//struct to work with API Responses 
...
async fn main() -> Result<() , Box<dyn std::error::Error + Send + Sync>> {
    ...
    let preamble = "Generate a sql code for the given statment";
  ...
  println!("");
  let sp = Spinner::new(&Spinners::Dots12 , "\t\t Open Ai is thinking...".into());
